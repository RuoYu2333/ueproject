 ...
 */
UCLASS(abstract)
class BROKENWAR_API AShooterCharacter : public ABrokenWarCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
protected:
	...
	// 【核心修改 2】：将 CurrentHP 升级为网络复制变量，并绑定 OnRep 回调
	...
	// 【核心修改 4】：当前持有的武器升级为网络同步，并绑定 OnRep 函数。
	// 这样当服务器强制给你换枪时，客户端会自动把枪塞进手部插槽，防穿模、防浮空。
...
public:
	...
	AShooterWeapon* GetActiveWeapon() const { return CurrentWeapon; }
